...
from Game_Karol_Warda.Object import Object, ObjectHandler, Bird
from Game_Karol_Warda.Player import Dinosaur

import random
from Game_Karol_Warda.Constants import WIDTH, HEIGHT, FULL_SCREEN, DISPLAY_NAME, BACKGROUND, ASSET_DICT
from Game_Karol_Warda.Constants import BG_POSITION_X, BG_POSITION_Y, POSITION_S_CACTUS_Y, POSITION_L_CACTUS_Y, POSITION_BIRD_Y, CLOUD_NUM, DISPLAY_FONT
from Game_Karol_Warda.Constants import POSITION_SCORE_Y, POSITION_SCORE_X, POSITION_RESTART_Y, POSITION_RESTART_X, POSITION_HIGH_SCORE_X, POSITION_HIGH_SCORE_Y, FONT_SIZE
